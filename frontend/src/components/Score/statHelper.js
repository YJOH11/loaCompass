...
const baseStats = {
  ...
  어깨: [30896,31934,33007,34115,35261,36445,37669,38934,40242,41593,42989,44433,45924,47534,49200,50924,52708,54555,56467,58445,60493,62612,64806,67076,69426,71858],
...
export function calculateAverageGemLevel(gemList) {
  if (!Array.isArray(gemList) || gemList.length === 0) return 0;
