        ...
        try {
            const response = await axios.get(
                `${import.meta.env.VITE_FLASK_API_URL}/api/search`, {
                    params: {
                        keyword,
                        content: searchType === "content", // Flask가 기대하는 boolean
                    },
                }
            );
            ...
            <div className="w-full max-w-3xl px-4">
                <div className="text-center mb-12">
                    ...
                    <div className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-gray-800 dark:to-gray-800 p-6 rounded-xl shadow-sm mb-8 max-w-2xl mx-auto">
                        <div className="flex items-center justify-center mb-4">
                            <svg className="h-6 w-6 text-indigo-500 dark:text-indigo-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span className="text-lg font-semibold">게시판 안내</span>
                        </div>
                ...
                <div className="mb-10">
                    <div className="relative">
                        <input
                            ...
                            className="w-full p-4 pl-5 pr-12 rounded-full bg-gray-100 dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-700 focus:outline-none text-center text-lg"
                        />
                        <button
                    ...
                    <div className="mt-8 flex justify-center space-x-2">
                        <label className="inline-flex items-center px-3 py-1 rounded-full bg-gray-200 dark:bg-gray-800 text-sm border">
                            <input
                                type="radio"
                                value="subject"
                ...
                {results.length > 0 ? (
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                        <div className="p-4 bg-gray-200 dark:bg-gray-700 border-b">
                            <h3 className="font-semibold">검색결과: {results.length}건</h3>
                        </div>
                        <div className="p-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {results.map((post, index) => (
                                    <div key={index} className="bg-gray-100 dark:bg-gray-800 border rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                        <a href={post.link} target="_blank" rel="noopener noreferrer" className="block">
                                            <div className="flex items-start p-4">
                                                ...
                                                <div className="ml-3 flex-1">
                                                    <h3 className="text-base font-medium mb-1 hover:text-blue-600 dark:hover:text-blue-400">
                                                        {post.title}
                                                    </h3>
                                            ...
                                            <div className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-xs flex justify-between text-gray-600 dark:text-gray-300 border-t">
                    ...
                    !isLoading && hasSearched && (
                        <div className="text-center text-gray-500 dark:text-gray-400 border rounded-lg p-12">
                            검색결과가 없습니다.
                        </div>
                    )
                )}
